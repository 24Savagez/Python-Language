...
button3 = Button(mainWindows, text="Click Me3", command=helpMe, height=5).grid(row=1, column=1)
label = Label(mainWindows, text="Hello World", width=10).grid(row=0, column=1)
