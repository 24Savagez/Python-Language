...
def interpret(number):
    ...
    if number in (9, 14, 15, 19, 23, 24, 32, 36, 40, 41, 42, 44, 45, 46, 50, 51, 54, 55, 56, 59, 63, 64, 65):
        ...
        meaning = "ให้โทษ ใครได้ผลรวมเหล่านี้ควรเปลี่ยน เหนื่อยมาก อุปสรรคมาก เจอปัญหารุมเร้า การงาน การเงิน ความรัก เกิดอุบัติเหตุชีวิตไม่จบไม่สิ้น"
    return meaning


# print(sum_phone_digit)
